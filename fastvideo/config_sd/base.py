...
def get_config():
    ...
    pretrained.model = "/mnt/sda/runhaofu/huggingface_cache/hub/models--runwayml--stable-diffusion-v1-5"
    ...
    # learning rate.
    train.learning_rate = 1e-5 # 1.4/1.5: 1e-5; 2.1:
    # Adam beta1.
